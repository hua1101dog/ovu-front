...
(function () {
    ...
    app.component('bigScreen', {
        transclude: true,
        templateUrl: '../show-cmcc/page/component/bigScreen.html',
        bindings: {
            gaodeData: '<',
            indoorData: '<',
            parkNo: '<',
    ...
    app.component('mapArea', {
        templateUrl: '../show-cmcc/page/component/mapArea.html',
        bindings: {
            gaodeData: '<',
            indoorData: '<'
        },
    ...
    app.component('gaodeMap', {
        templateUrl: '../show-cmcc/page/component/gaodeMap.html',
        bindings: {
            onIconClick: '&',
            gaodeData: '<'
        },
    ...
    app.service('gaodeMapService', ['$timeout', 'iconService', 'gaodeHttpServer', '$q', 'AppService', '$compile', function ($timeout, iconService, httpHelper, $q, AppService, $compile) {
        ...
        this.renderGaode = function (map, gaodeData, $ctrl, type) {
            ...
            var url = "/show-cmcc/res/img/2046map.png";
    ...
    app.component('indoorMap', {
        templateUrl: '../show-cmcc/page/component/indoorMap.html',
        bindings: {
            onBackToGaode: '&',
            indoorData: '<'
        },
        ...
        controller: ['$scope', '$rootScope', 'gaodeHttpServer', '$timeout', '$http', 'AppService', '$state', '$q', function ($scope, $rootScope, httpHelper, $timeout, $http, AppService, $state, $q) {
            var $ctrl = this;
            var imgBaseUrl = '/show-cmcc/res/img/indoor-icon/';
            ...
            $ctrl.$onInit = function () {
                ...
                var map = new AirocovMap.Map({
                    ...
                    mapList: [{ //传入本楼栋内所有楼层信息
                        name: "F1",
                        mapUrl: "/show-cmcc/res/indoor-data/a6-3f(hf).geojson" //地图文件
                        // other: dataOther //第三方数据
                    }],
                    themeUrl: "/show-cmcc/res/img/indoor-icon/fillcolor.json", //共用渲染文件
                    position: { //初始观察位置
                        x: 0,
                        y: -200,
                        z: 100
                    ...
                    httpHelper.api('GET')(url)(prams).then(function (res) {
                        ...
                        if (res.data.data) {
                            ...
                            res.data.data.forEach(function (value) {
                                if(!value.latitude_ && !value.maplng){
                                    return;
                                }
                                if (type == "watch") {
                                    // 电子巡更
                                    if (value.maplnt && value.maplng) {
                                        value.maplnt = Number.parseFloat(value.maplnt)+0.29284003403396;
                                        value.maplng  = Number.parseFloat(value.maplng )-8.275554099196;
                                    ...
                                    value.latitude_ = Number.parseFloat(value.latitude_)+0.29284003403396;
                                    value.longitude_  = Number.parseFloat(value.longitude_)-8.275554099196;
                                          ...
                                          position.mapTitle = {
                                            ...
                                            if (value.equip_type == 'infrared') {
                                                ...
                                                if (value.equip_status == 1) {
                                                    ...
                                                    position.logo =imgBaseUrl + "sign_alarm_n.png";
                                                }
                      ...
                      res.forEach(function (list, indexOne) {
                        list.data.data && list.data.data.forEach(function (value, indexTwo) {
                          if (value.latitude_ && value.longitude_) {
                            ...
                            var lat = Number.parseFloat(value.latitude_)+0.29514003403396;
                            var lon  = Number.parseFloat(value.longitude_)-8.279554099196;
                            var tempVal = {
                              dept: myDept,
                              latitude_: lat,
                              longitude_: lon,
    ...
    app.component('infoPanel', {
        transclude: true,
        templateUrl: '../show-cmcc/page/component/infoPanel.html',
        bindings: {},
        controller: function () {
            var $ctrl = this;
            $ctrl.$onInit = function () {};
    ...
    app.component('palyModal', {
        ...
        templateUrl: '/show-cmcc/page/component/vedio.html',
        controllerAs: 'vm',

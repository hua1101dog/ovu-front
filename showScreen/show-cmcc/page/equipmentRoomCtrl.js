...
(function () {
    ...
    function equipmentRoomCtrl($scope, $http,AppService) {
        ...
        ///ovu-screen/pcos/show/equip/equipHouseRuning.do?parkNo=042010600012046
        $http.get('/ovu-screen/pcos/show/equip/equipHouseRuning.do?parkNo='+AppService.parkNo).success(function (res) {

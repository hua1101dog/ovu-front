...
(function () {
    ...
    function equipmentCtrl($scope, $http, AppService) {
        ...
        ///ovu-pcos/pcos/show/total.do?parkNo=042010600012046
        //"{\"data\":{\"total\":1468,\"broken_num\":1,\"fail_num\":11,\"regular_num\":1456,\"max_regular_days\":177628},\"success\":true}"
        $http.get('/ovu-pcos/pcos/show/total.do?parkNo='+AppService.parkNo).success(function (res) {
        ...
        $http.get('/ovu-pcos/pcos/show/equip/list?parkNo='+AppService.parkNo).success(function (res) {
            var markers=[];
        ...
        $http.get('/ovu-pcos/residence/workOrder/queryWorkUnitList.do',{params:{parkNo: parkNo}}).success(function (result) {
        ...
        function addMarker(data) {
            var marker = new AMap.Marker({
                ...
                map : vm.map,
                zIndex: 1000,
                icon : "/ovu-pcos/show2046/res/img/icon_map_localize.png"
            });
            return marker;
        }
    }

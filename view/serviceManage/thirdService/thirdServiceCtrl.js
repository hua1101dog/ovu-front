(function () {
    ...
    // 水费账单
    app.controller("thirdService", function (
        $scope,
        $rootScope,
        $http,
        $filter,
        ...
        $scope.showEditModal = function (item) {
            ...
            var modal = $uibModal.open({
                ...
                size: "md",
                templateUrl:
                    "/view/serviceManage/thirdService/modal.thirdService.html",
                controller: "modal.thirdServiceCtrl",
                resolve: { categorySetting: copy, item: item },
            });
            modal.result.then(
                function () {
                    // $scope.find();

...
(function() {
    ...
    app.controller('standardPriceQueryCtrl', function ($scope,$rootScope,$http,$filter,$uibModal,fac) {
        document.title = "标准价查询";
        var width=$(window).width()-300
        $('#table_li').width(width)
        ...
        $scope.find = function (pageNo) {
            ...
            fac.getPageResult("/ovu-park/backstage/sale/saleStandardAdjustmentProject/queryStandardPrice", $scope.search, function (data) {

...
(function() {
    ...
    app.controller('reservePriceQueryCtrl', function ($scope,$rootScope,$http,$filter,$uibModal,fac) {
        document.title = "底价查询";
        ...
        $scope.find = function (pageNo) {
            ...
            fac.getPageResult("/ovu-park/backstage/sale/saleMinAdjustmentProject/queryMinPrice", $scope.search, function (data) {

(function () {
    ...
    app.controller('examAgreementCtrl', function ($scope, $rootScope, $http, $uibModal, $filter, fac, $location) {
        ...
        $scope.submint = function (state) {
            ...
            $http.post("/ovu-park/backstage/rental/contractBaseInfo/approve", params, fac.postConfig).success(function (resp) {
                if (resp.code == 0) {
        ...
        $scope.estimatedBill = function () {
            var modal = $uibModal.open({
                ...
                controller: 'examEstimatedBillCtrl',
                resolve: {
        ...
        function getRentAgreement(data) {
            ...
            $scope.otherChargeList.forEach((value, index) => {
                ...
                value.taxRate = value.taxRate || $scope.contractMsg.taxRate || 0;
    ...
    //预计应收账单
    app.controller('examEstimatedBillCtrl', function ($scope, $rootScope, $http, $uibModalInstance, $timeout, $filter, fac, item) {

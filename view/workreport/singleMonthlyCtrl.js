...
(function () {
    ...
    app.controller("singleMonthlyCtrl", function ($scope, $rootScope, $http, $filter, $uibModal, fac) {
        document.title = "工作月报";
        $scope.pageModel = {};
        $scope.search = {};
        $scope.id = "";
        ...
        $scope.find = function (pageNo) {
            ...
            angular.extend($scope.search, { currentPage: pageNo || $scope.pageModel.currentPage || 1, pageSize: $scope.pageModel.pageSize || 10, reportType: 3 });
        ...
        $scope.showAddModal = function (id, createTime, parkId, show) {
            ...
            var modal = $uibModal.open({
                animation: false,
                templateUrl: '../view/workreport/monthly/modal.singlemonthlyEdit.html',
                size: 'max',
                controller: 'newmonthlyEditModalCtrl',
                controllerAs: 'vm',
                resolve: {
                    data: {
                        id: id,
    ...
    app.controller("newmonthlyEditModalCtrl", function ($scope, $uibModal, $uibModalInstance, $http, fac, data) {
        ...
        //进入页面首先直接查询工单完成情况统计
         ...
         $http.post("/ovu-pcos/pcos/workUnit/query.do", {
            reportType: 3,
            parkId: data.parkId,
        ...
        $scope.find = function (pageNo, workunitType, status,deptId) {
            ...
            angular.extend($scope.search, { currentPage: pageNo || $scope.pageModel.currentPage || 1, pageSize: $scope.pageModel.pageSize || 10, reportType: 3, parkId: data.parkId, createTime: data.createTime});

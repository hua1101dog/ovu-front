...
(function () {
    ...
    app.controller("singleWeeklyCtrl", function ($scope, $rootScope, $http, $filter, $uibModal, fac) {
        document.title = "工作周报";
        $scope.pageModel = {};
        $scope.search = {};
        $scope.id = "";
        ...
        $scope.showAddModal = function (id, createTime, parkId, show) {
            ...
            var modal = $uibModal.open({
                animation: false,
                templateUrl: '../view/workreport/weekly/modal.singleweeklyEdit.html',
                size: 'max',
                controller: 'newweeklyEditModalCtrl',
                controllerAs: 'vm',
                resolve: {
                    data: {
                        id: id,
    ...
    app.controller("newweeklyEditModalCtrl", function ($scope, $rootScope, $uibModal, $uibModalInstance, $http, fac, data) {

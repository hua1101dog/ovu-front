(function () {
    ...
    app.controller('fixPriceCtl', function ($scope, $rootScope, $http, $filter, $uibModal, fac) {
        ...
        $scope.sellTatusByTab = function (event, type) {
            ...
            delete $scope.search.sellStatus;
            ...
            if ('no' == type) {
                ...
                $scope.search.sellStatus = 2
            } else if ('rentSale' == type) {
                $scope.search.sellStatus = 3
            } else {
                $scope.search.sellStatus = ""
            }
        ...
        // $scope.changeAll = function (selectAll) {  
        ...
        //点击定义
        $scope.showFixModal = function (house, type) {
            ...
            var modal = $uibModal.open({
                animation: false,
                size: 'md',
                templateUrl: '/view/projectSpace/pricingManage/modal.fixPrice.html',
          ...
          //点击批量重定义
          $scope.batchShowFixModal = function (){
            var buf = [];
            ...
            var modal = $uibModal.open({
                animation: false,
                size: 'md',
                templateUrl: '/view/projectSpace/pricingManage/modal.batchFixPrice.html',
                controller: 'batchEditPriceCtrl',
                resolve: {
                    param: param
                }
            });

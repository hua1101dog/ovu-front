...
angular.module("materialCalendar").service("MaterialCalendarData", [function ($compile) {
...
angular.module("materialCalendar").directive("calendarMd", ["$compile", "$parse", "$templateRequest", "$q", "$timeout", "materialCalendar.Calendar", "MaterialCalendarData", function ($compile, $parse, $templateRequest, $q, $timeout, Calendar, CalendarData) {

(function () {
    ...
    app.controller('fireControlScenarioCtrl', function ($scope, $rootScope, $http, $filter, $uibModal, $interval) {
        document.title = "OVU-消防管理";
        ...
        setPie(data1,'tempInfo','温度传感器');
        setPie(data2,'smokeInfo','烟感传感器');
        setPie(data3,'pressInfo','水压液位传感器');

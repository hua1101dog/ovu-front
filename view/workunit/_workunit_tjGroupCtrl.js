...
(function() {
	...
	app.controller('workunitTjGroupCtl', function ($scope,$rootScope, $http,$filter,$uibModal,fac) {
      ...
      app.modulePromiss.then(function(){
          $scope.search={domainId:app.domain.id,startTime:moment().format('YYYY-MM-DD'),endTime:moment().format('YYYY-MM-DD')};
          $scope.find(1);
      });
      ...
      $scope.export = function(){
        ...
        elemIF.src = "/ovu-pcos/workunit/statistics/exportGroup.do?json="+param;

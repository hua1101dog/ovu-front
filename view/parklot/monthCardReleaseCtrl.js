...
(function () {
    ...
    app.controller('monthCardReleaseCtrl', function ($scope, $rootScope, $uibModal, $http, $filter, fac) {
        document.title = "月卡放行";
        ...
        $scope.export = function () {
            ...
            elemIF.src = "/ovu-pcos/pcos/parklot/payment/export.do?json=" + param+"&type=5";

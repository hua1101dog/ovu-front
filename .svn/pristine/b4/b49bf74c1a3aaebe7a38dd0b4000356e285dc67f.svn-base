...
(function () {
    ...
    app.controller('abnormalReleaseCtrl', function ($scope, $rootScope, $uibModal, $http, $filter, fac) {
        document.title = "异常放行";
        ...
        $scope.export = function () {
            ...
            elemIF.src = "/ovu-pcos/pcos/parklot/payment/export.do?json=" + param+"&type=2";

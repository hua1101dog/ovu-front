...
//    var URL = window.UEDITOR_HOME_URL || getUEBasePath();
	var URL = window.UEDITOR_HOME_URL || CONST_PROJECT.ueditorPath;//"http://localhost/mfw/ueditor/";
	//var linux URL
	//var URL = window.UEDITOR_HOME_URL || "/res/js/ueditor/";
    /**
     * 配置项主体。注意，此处所有涉及到路径的配置别遗漏URL变量。
     */
    window.UEDITOR_CONFIG = {
    	Domain:CONST_PROJECT.fullPath,//"http://localhost",
        //为编辑器实例添加一个路径，这个不能被注释
        UEDITOR_HOME_URL : URL

        //图片上传配置区
        ,imageUrl:URL+"jsp/imageUp.jsp"             //图片上传提交地址
        ,imagePath:CONST_PROJECT.ueditorResPath// + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,scrawlPath:CONST_PROJECT.ueditorResPath//+"jsp/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:CONST_PROJECT.ueditorResPath// + "jsp/"                   //附件修正地址，同imagePath
        ...
        ,catcherPath:CONST_PROJECT.ueditorResPath

(function() {
    ...
    // 运行中的流程的控制器
    app.controller("deleteProcessManageCtrl", function($scope, $rootScope, $uibModal, $http, $filter, fac, $log) {
        ...
        $scope.find = function(pageNo) {
            ...
            fac.getPageResult("/ovu-workflow/act/process/deleted", $scope.runProcessSearch, function(data) {

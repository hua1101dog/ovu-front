...
//++++++++++++++++
function getRay(camera, OrbitControls, a2, b2, mouseX, mouseY) //a=window.innerWidth,b=window.innerHeight;这是求解屏幕任意一点往三维世界做射线，用于几何模型的捕捉
{
...
//功能：求相机位置到焦点位置的长度
//++++++++++++++++
function R(camera, OrbitControls) {
    var center, Distance;
...
//++++++++++++++++
function aa2(camera, OrbitControls) {
...
//++++++++++++++++++
function getNewXYZ(a, XL, distance) {
    var dXL, p, dxyz;
    dXL = length_1(XL);
    p = [];
...
//++++++++++++++++++++
function getBound(a, b, c, fov, width, heigth) {
...
//功能：相机的水平视角宽度
//++++++++++++++++++++++
function getSP(width, heigth, fov) {
...
//功能：求解三维坐标转为屏幕坐标
//+++++++++++++++++++++
function getPixelFromCoordinate(a, b, c, fov, width, heigth) {
...
//++++++++++++++++++++
function d2ToPx(p1, width, heigth, width1, heigth1) {
    var dx, dy, p2 = [];

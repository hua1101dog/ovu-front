...
<div id="angularId" ng-controller="workDataCtrl" >
	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">拓展状态数据列表
...
<script >
	(function() {
		document.title ="OVU-工作数据录入";
		var app = angular.module("angularApp");
		//人员异动ctl
		app.controller('workDataCtrl', function ($scope,$rootScope, $http,$filter,$uibModal,fac) {
			...
			$scope.showEditModal = function () {
				var modal = $uibModal.open({
					animation: false,
					size: 'lg',
					templateUrl: '/ovu-pcos/common/modal.workData.html',
					controller: 'workDataModalCtrl'
				});
			...
			$scope.showDetailModal = function () {
				var modal = $uibModal.open({
					animation: false,
					size: 'lg',
					templateUrl: '/ovu-pcos/common/modal.workDataDetail.html',
					controller: 'workDataDetailModalCtrl'
				});
				modal.result.then(function () {
		...
		app.controller('workDataModalCtrl', function ($scope, $http, $uibModalInstance, $filter, fac) {
		...
		app.controller('workDataDetailModalCtrl', function ($scope, $http, $uibModalInstance, $filter, fac) {
			$scope.cancel = function () {
				$uibModalInstance.dismiss('cancel');
			};
		});

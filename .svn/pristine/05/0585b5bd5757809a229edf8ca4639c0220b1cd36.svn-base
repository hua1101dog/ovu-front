(function () {
    ...
    app.controller('financialStatementCtrl', function ($scope, $rootScope, $http, $filter, $uibModal, fac) {
        document.title = "OVU-财务账单";
        $scope.current = 1;
        ...
        $scope.findRef = function () {
            ...
            $scope.comType = {};
            $scope.find()
            // $(".checkState span input").each().attr('checked',false)
            $("#orderType").attr('checked', false)
            $("#orderType_1").attr('checked', false)
        ...
        $scope.showDetail = function (data) {
            var modal = $uibModal.open({
                ...
                // appendTo: angular.element('#angularId'),

(function(angular, document, win) {
    ...
    app.controller('checkWorkUnitCtrl', ['$scope', '$rootScope', '$http', '$uibModal', 'fac', 'decoration.commonService', function($scope, $rootScope, $http, $uibModal, fac, myService) {
		document.title = "验收管理工单";
        ...
        //    search.parkId = $scope.search.parkId;
            ...
            if (searchobj) {
                ...
                search.unitStatus = searchobj.unit_status;
            }

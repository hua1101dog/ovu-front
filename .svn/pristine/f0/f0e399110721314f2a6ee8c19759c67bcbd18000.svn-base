 ...
 Map.prototype = {
     ...
     init: function() {
         ...
         mapdata.load("geojson/hfjrgpmt.geojson", "geojson/route/route-3.json");
         this.nowMap = mapdata;
         //三维场景初始化
         ...
         this.camera.position.set(-0.0000014124710796905837,238.25918968124677,-0.00023826559351207305);

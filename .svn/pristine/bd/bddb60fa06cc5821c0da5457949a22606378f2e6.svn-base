...
<div id="angularId" ng-controller="personDataCtrl" >
	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">人员编制、人员结构数据列表
...
<script >
	(function() {
		document.title ="OVU-人员数据录入";
		var app = angular.module("angularApp");
		//人员异动ctl
		app.controller('personDataCtrl', function ($scope,$rootScope, $http,$filter,$uibModal,fac) {
			...
			$scope.showEditModal = function () {
				var modal = $uibModal.open({
					animation: false,
					size: 'lg',
					templateUrl: '/ovu-pcos/common/modal.personData.html',
					controller: 'personDataModalCtrl'
				});
			...
			$scope.showDetailModal = function () {
				var modal = $uibModal.open({
					animation: false,
					size: 'lg',
					templateUrl: '/ovu-pcos/common/modal.personDataDetail.html',
					controller: 'personDataDetailModalCtrl'
				});
				modal.result.then(function () {
		...
		app.controller('personDataModalCtrl', function ($scope, $http, $uibModalInstance, $filter, fac) {
		...
		app.controller('personDataDetailModalCtrl', function ($scope, $http, $uibModalInstance, $filter, fac) {
			$scope.cancel = function () {
				$uibModalInstance.dismiss('cancel');
			};
		});

...
<div id="angularId" ng-controller="deviceDataCtrl" >
	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">设备故障率数据列表
...
<script >
	(function() {
		document.title ="OVU-设备数据录入";
		var app = angular.module("angularApp");
		//人员异动ctl
		app.controller('deviceDataCtrl', function ($scope,$rootScope, $http,$filter,$uibModal,fac) {
			$scope.pageModel = {};
			...
			$scope.showEditModal = function () {
				var modal = $uibModal.open({
					animation: false,
					size: 'lg',
					templateUrl: '/ovu-pcos/common/modal.deviceData.html',
					controller: 'deviceDataModalCtrl'
				});
			...
			$scope.showDetailModal = function () {
				var modal = $uibModal.open({
					animation: false,
					size: 'lg',
					templateUrl: '/ovu-pcos/common/modal.deviceDataDetail.html',
					controller: 'deviceDataDetailModalCtrl'
				});
				modal.result.then(function () {
		...
		app.controller('deviceDataModalCtrl', function ($scope, $http, $uibModalInstance, $filter, fac) {
		...
		app.controller('deviceDataDetailModalCtrl', function ($scope, $http, $uibModalInstance, $filter, fac) {
			$scope.cancel = function () {
				$uibModalInstance.dismiss('cancel');
			};
		});

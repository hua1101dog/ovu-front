...
(function() {
    ...
    app.controller('historyStandardPriceCtrl', function ($scope,$rootScope,$http,$filter,$uibModal,fac) {
        ...
        $scope.find = function (pageNo) {
            ...
            fac.getPageResult("/ovu-park/backstage/sale/saleStandardAdjustmentProject/queryStandardPriceHistory", $scope.search, function (data) {

(function(){
	...
	app.controller('documentManageCtrl', function ($scope, $rootScope, $sce, $uibModal, $state, $http, $filter, fac) {
		document.title = '文档管理';
        $scope.pageModel = {};
        $scope.search = {};
        ...
        $scope.createFolder = function(item){
        	...
        	if(copy.type == undefined || !copy.type == 4){
        		copy.type = 4;
        	}
            var modal = $uibModal.open({
                animation: false,
                size: 'md',
                templateUrl: '/view/gallery/materialManagement/documentManage/modal.addEditFolder.html',
                controller: 'documentFolderEditModelCtrl',
                resolve: {
                    param: copy
                }
            });
        ...
        $scope.editFile = function(item){
            ...
            var modal = $uibModal.open({
                animation: false,
                size: 'md',
                templateUrl: '/view/gallery/materialManagement/documentManage/modal.editFile.html',
                controller: 'documentFileModifyModelCtrl',
                resolve: {
                    param: copy
                }
            });
        ...
        $scope.createFile = function(){
            var modal = $uibModal.open({
                animation: false,
                size: 'md',
                templateUrl: '/view/gallery/materialManagement/documentManage/modal.addEditFile.html',
                controller: 'documentFileEditModelCtrl',
                resolve: {
        ...
        $scope.showFile = function(o){
        	var modal = $uibModal.open({
                animation: false,
                size: 'lg',
                templateUrl: '/view/gallery/materialManagement/documentManage/modal.showFile.html',
                controller: 'documentShowFileModelCtrl',
                resolve: {
                    item: o
                }
            });
	...
	// 新增编辑Controller
    app.controller('documentFolderEditModelCtrl', function ($scope,$rootScope, $http, $uibModal, $uibModalInstance, $filter, fac, param) {
    	$scope.item = param || {};
    ...
    // 新增编辑Controller
    app.controller('documentFileModifyModelCtrl', function ($scope,$rootScope, $http, $uibModal, $uibModalInstance, $filter, fac, param) {
    	$scope.item = param || {};
    ...
    //新增，编辑文件
    app.controller('documentFileEditModelCtrl', function ($scope,$rootScope, $http, $uibModal, $uibModalInstance, $filter, fac, folder) {
    	...
    	$scope.openRetPage = function(retList){
            var modal = $uibModal.open({
                animation: true,
                component: 'documentRetModelModal',
                size: 'lg',
                resolve: {
                    item: function() {
                        return retList;
    ...
    //展示文件
    app.controller('documentShowFileModelCtrl', function ($scope,$rootScope, $http, $uibModal, $sce ,$uibModalInstance, $filter, fac, item) {
		$scope.Document = angular.copy(item);
		$scope.Document.filePath = $sce.trustAsResourceUrl($scope.Document.filePdfPath);
    ...
    app.component('documentRetModelModal', {

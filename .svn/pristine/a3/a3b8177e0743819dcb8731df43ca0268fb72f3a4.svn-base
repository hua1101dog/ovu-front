...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax, defaults,resetField,
    ...
    */
    message = {
        invalid         : '无效输入',//'invalid input',
        checked         : '请勾选',//'must be checked',
        empty           : '请输入该项',//'please put something here',
        min             : '输入长度过短',//'input is too short',
        max             : '输入长度过长',//'input is too long',
        number_min      : '数值过小',//'too low',
        number_max      : '数值过大',//'too high',
        url             : '链接格式错误',//'invalid URL',
        number          : '请输入数字',//'not a number',
        email           : '邮箱格式不正确',//'email address is invalid',
        email_repeat    : '邮箱比对不正确',//'emails do not match',
        password_repeat : '密码比对不正确',//'passwords do not match',
        repeat          : '格式不符合',//'no match',
        complete        : '输入不正确',//'input is not complete'
        select          : '请选择'//'Please select an option'
    };
    ...
    */
    ...
    /* reset a single form field by it's type and specific (custom) attributes
    */
    function resetField(){
        // skip testing fields whom their type is not HIDDEN but they are HIDDEN via CSS.
        if( this.type !='hidden' && $(this).is(':hidden') )

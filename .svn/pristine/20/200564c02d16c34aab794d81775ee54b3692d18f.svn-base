 ...
 */
THREE.OrbitControls = function ( object, domElement, detectModels, clickModels) {
    ...
    var rotateStart1 = new THREE.Vector2();
    var rotateStart2 = new THREE.Vector2();
    var rotateEnd1 = new THREE.Vector2();
    var rotateEnd2 = new THREE.Vector2();
    var rotateDelta1 = new THREE.Vector2();
    ...
    function onTouchStart( event ) {
        ...
        switch ( event.touches.length ) {
            ...
            case 2:	// two-fingered touch: dolly
                ...
                if (scope.enableDollyPan === false) return;
